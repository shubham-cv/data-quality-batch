...
def get_rule(rule, rule_entity_map, entity_properties, entity_template_properties, rule_properties, rule_template,rule_template_properties):
    ...
    rule1['rule_details'] = rule_details
...
if choice == 'rule':
    ...
    print(rule[rule['rule_name'] == rule_name]['ruleset_id'])
    ruleset_id = rule[rule['rule_name'] == rule_name]['ruleset_id'].values[0]
    rulset = ruleset[ruleset['ruleset_id'] == ruleset_id]
